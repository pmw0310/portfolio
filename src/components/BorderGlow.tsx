...
/**
 * 테두리 및 글로우 효과를 제공하는 카드 컨테이너 컴포넌트입니다.
 * @param props - BorderGlow 컴포넌트 속성
 * @returns BorderGlow UI 컴포넌트
 */
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`relative z-[1] w-full ${contentClassName}`}>{children}</div>
    </div>
  );
};
